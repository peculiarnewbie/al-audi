...
function SignUpPage() {
    ...
    return (
        <div class="mx-auto grid min-h-[calc(100vh-7rem)] max-w-6xl gap-8 px-6 py-10 lg:grid-cols-[1fr_1fr]">
            <section class="glass-panel p-8">
                <div class="space-y-2">
                    ...
                    <p class="text-sm leading-7 text-slate-600">
                        Sign up with Google for quick access, or create an account with email and password.
                    </p>
                </div>
            ...
            <section class="glass-panel flex flex-col justify-between p-8">
                <div class="space-y-4">
                    ...
                    <h2 class="font-display text-3xl font-semibold text-[color:var(--dashboard-ink)]">
                        Accounts are first-party. Roles stay school-managed.
                    </h2>
                    <p class="text-sm leading-7 text-slate-600">
                        Signing up gives you an account. Admins still decide
                        whether that account should act as a student, teacher,
                        admin, or remain pending.
                    </p>
                </div>
                <div class="grid gap-4">
                    <div class="rounded-3xl border border-white/70 bg-white/70 p-5">
                        ...
                        <p class="mt-3 text-sm leading-6 text-slate-600">
                            Most new accounts start with no role until an admin
                            approves them.
                        </p>
                    </div>
                    <div class="rounded-3xl border border-white/70 bg-white/70 p-5">
                        ...
                        <p class="mt-3 text-sm leading-6 text-slate-600">
                            Existing teachers and students keep their same app
                            IDs when they sign up with the matching email.
                        </p>
                    </div>
                </div>
            </section>
